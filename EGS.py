...
# consider cached and/or raw data from web options instead
# note that this data source is different than before.
# this one should include descriptions; formatted taglist; sellers
df = pd.read_csv("~/Desktop/dshw/EGS_project/all_withtags.csv")
